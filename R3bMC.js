...
client.on('ready', function(){ // Leaked by [ @M3a4x ]
    var ms = 30000 ;
    var setGame = [`R3bMC Community `,` R3b Bot By R3b TeaM !`];
    var i = -1;
    var j = 0;
...
coll.first().delete()
 ...
 .setTitle(`Welcome To $R3bMC Community`)
